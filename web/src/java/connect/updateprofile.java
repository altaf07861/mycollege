...
public class updateprofile extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
      ...
      String cmd="update studentdetails set name='"+name+"',contactno='"+contactno+"',emailaddress='"+emailaddress+"',address='"+address+"',profilepic='"+filename+"' where enrollmentno='"+enrollmentno+"' ";
      ...
      if(b==true)
      {
          response.sendRedirect("studentpage/profile.jsp?f=1");
      }
      else
      {
           response.sendRedirect("studentpage/profile.jsp?f=0");
      }
